...
X <- data[, c("OverallQual","GrLivArea","GarageCars", "GarageArea", "TotalBsmtSF", "X1stFlrSF","FullBath", "TotRmsAbvGrd","YearBuilt","YearRemodAdd","GarageYrBlt","MasVnrArea","Fireplaces","BsmtFinSF1","LotFrontage","WoodDeckSF","OpenPorchSF","HalfBath", "LotArea")]
#"OverallQual","GrLivArea","GarageCars", "GarageArea", "TotalBsmtSF", "X1stFlrSF", "FullBath", "TotRmsAbvGrd","YearBuilt",
#"YearRemodAdd","GarageYrBlt","MasVnrArea","Fireplaces","BsmtFinSF1"/,"LotFrontage","WoodDeckSF",/ "2ndFlrSF","OpenPorchSF","HalfBath", "LotArea")]
